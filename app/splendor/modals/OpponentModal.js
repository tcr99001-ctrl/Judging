      ...
      <div className="panel modal-panel max-w-lg" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="grid gap-3 px-4 py-4">
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-2xl border border-white/10 bg-slate-950/46 px-3 py-3 text-sm font-black text-white">단서 {player.clueCount || 0}</div>
            <div className="rounded-2xl border border-white/10 bg-slate-950/46 px-3 py-3 text-sm font-black text-white">리드 {player.reservedCount || 0}</div>
            <div className="rounded-2xl border border-white/10 bg-slate-950/46 px-3 py-3 text-sm font-black text-white">대조 {player.breakthroughs || 0}</div>
            <div className="rounded-2xl border border-white/10 bg-slate-950/46 px-3 py-3 text-sm font-black text-white">추궁 {player.witnessCount || 0}</div>
          </div>

          <div className="rounded-2xl border border-white/10 bg-slate-950/46 px-4 py-4 text-sm font-bold leading-6 text-slate-300">
