        ...
        <div className="min-h-0 overflow-y-auto px-4 py-4">
          <div className="grid gap-4">
            <div className="grid gap-4 sm:grid-cols-[132px_1fr]">
              <div className="overflow-hidden rounded-[20px] border border-[#655142]/30 bg-[#161210]">
              ...
              <div className="rounded-[20px] border border-white/10 bg-black/10 px-4 py-4">
                ...
                <div className="mt-3 text-xs font-black tracking-[0.12em] text-[#baa691]">{witness.risk}</div>
            ...
            {witness.effectLines?.length ? (
              <div className="rounded-[20px] border border-white/10 bg-black/10 px-4 py-4">
                <div className="text-[11px] font-black tracking-[0.16em] text-[#baa691]">추궁 결과</div>
