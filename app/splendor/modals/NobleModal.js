...
export default function NobleModal({ open, witness, myData, onClose, onConfirm }) {
  ...
  return (
    <div className="modal-layer">
      ...
      <div className="panel modal-panel max-w-xl overflow-hidden" onClick={(event) => event.stopPropagation()}>
        <div className="flex items-start justify-between border-b border-white/10 px-4 py-4">
          <div>
            <div className="text-[11px] font-black tracking-[0.18em] text-[#c8af85]">인물 파일</div>
        ...
        <div className="grid gap-4 px-4 py-4">
          <div className="grid gap-4 sm:grid-cols-[132px_1fr]">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/10 px-4 py-4">
              ...
              <div className="mt-2 text-sm font-bold leading-6 text-[#ecdfca]">{witness.quote}</div>
          ...
          {witness.effectLines?.length ? (
            <div className="rounded-3xl border border-white/10 bg-black/10 px-4 py-4">
              <div className="text-[11px] font-black tracking-[0.16em] text-[#baa691]">열리면</div>
